...
NICKNAME = 'E0002_1150296_PYTHON2'
...
while True:
    ...
    print(f'targetBall_x : {targetBall_x}')
    print(f'targetBall_y : {targetBall_y}')
    ...
    print(f'targetBall_x : {targetBall_x}')
    print(f'targetBall_y : {targetBall_y}')
    print(f'balls[5][0] : {balls[5][0]}')
    print(f'balls[5][1] : {balls[5][1]}')
